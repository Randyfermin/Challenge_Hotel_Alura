...
public class Login extends JFrame {
	...
	private void Login() {
		...
		usuarioDao = new UsuarioDAO(new ConnectionFactory().recuperaConexion());
		
		Usuario usuario = new Usuario();
		usuario.setUserName(txtUsuario.getText());
		usuario.setUserPwd(contrase);
		
        //if(txtUsuario.getText().equals(usuario.getUserName()) && contrase.equals(usuario.getUserPwd())){
        if(usuarioDao.grandAccess(usuario)){
