...
public class RegistroHuesped extends JFrame {
	...
	public void setLocalizadorReserva(Huesped huesped) {
		
		txtNreserva.setText(huesped.getReservas().getLocalizaReserva());
	...
	public RegistroHuesped() {
		...
		lblTitulo.setBounds(499, 55, 411, 42);
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (!txtNombre.getText().isEmpty() && 
					...
					reservasDAO.guardarReserva(huesped.getReservas());
					...
					Exito exito = new Exito(menuUsuario);
