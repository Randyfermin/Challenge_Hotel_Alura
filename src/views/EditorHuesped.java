...
public class EditorHuesped extends JFrame {
	...
	public void setHuesped(Huesped huesped) {
		...
		txtFechaN.setDate(this.huesped.getFechaNacimiento());
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EditorHuesped frame = new EditorHuesped();
	 ...
	 * Create the frame.
	 */
	public EditorHuesped() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(EditorHuesped.class.getResource("/imagenes/lOGO-50PX.png")));
		...
		JLabel lblTitulo = new JLabel("EDITOR HUÉSPED");
		lblTitulo.setHorizontalAlignment(SwingConstants.CENTER);
		lblTitulo.setBounds(0, 55, 421, 42);
		...
		txtNombre.setBounds(30, 135, 285, 33);
		...
		txtApellido.setBounds(30, 204, 285, 33);
		...
		txtFechaN.setBounds(30, 278, 285, 36);
		...
		txtNacionalidad.setBounds(30, 350, 289, 36);
		...
		txtTelefono.setBounds(30, 424, 285, 33);
		...
		separator_1_2.setBounds(30, 170, 289, 2);
		separator_1_2.setForeground(new Color(12, 138, 199));
		separator_1_2.setBackground(new Color(12, 138, 199));
		contentPane.add(separator_1_2);
		
		JSeparator separator_1_2_1 = new JSeparator();
		separator_1_2_1.setBounds(30, 240, 289, 2);
		separator_1_2_1.setForeground(new Color(12, 138, 199));
		separator_1_2_1.setBackground(new Color(12, 138, 199));
		contentPane.add(separator_1_2_1);
		
		JSeparator separator_1_2_2 = new JSeparator();
		separator_1_2_2.setBounds(30, 314, 289, 2);
		separator_1_2_2.setForeground(new Color(12, 138, 199));
		separator_1_2_2.setBackground(new Color(12, 138, 199));
		contentPane.add(separator_1_2_2);
		
		JSeparator separator_1_2_3 = new JSeparator();
		separator_1_2_3.setBounds(30, 386, 289, 2);
		separator_1_2_3.setForeground(new Color(12, 138, 199));
		separator_1_2_3.setBackground(new Color(12, 138, 199));
		contentPane.add(separator_1_2_3);
		
		JSeparator separator_1_2_4 = new JSeparator();
		separator_1_2_4.setBounds(30, 457, 289, 2);
		separator_1_2_4.setForeground(new Color(12, 138, 199));
		separator_1_2_4.setBackground(new Color(12, 138, 199));
		contentPane.add(separator_1_2_4);
		
		JPanel btnguardar = new JPanel();
		btnguardar.setBounds(10, 560, 121, 35);
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (!txtNombre.getText().isEmpty() && 
					...
					Date NacimientoqlDate = new Date(txtFechaN.getDate().getTime());
					huesped.setFechaNacimiento(NacimientoqlDate );
		...
		panel.setBounds(421, 0, 489, 634);
		panel.setBackground(new Color(12, 138, 199));
		contentPane.add(panel);
		panel.setLayout(null);
		
		JLabel imagenFondo = new JLabel("");
		imagenFondo.setBounds(0, 121, 489, 502);
		panel.add(imagenFondo);
		imagenFondo.setIcon(new ImageIcon(EditorHuesped.class.getResource("/imagenes/registro.png")));
		
		JLabel logo = new JLabel("");
		logo.setBounds(194, 39, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon(EditorHuesped.class.getResource("/imagenes/Ha-100px.png")));
